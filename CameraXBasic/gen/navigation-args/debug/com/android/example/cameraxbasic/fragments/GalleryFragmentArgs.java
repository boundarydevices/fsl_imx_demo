...
public class GalleryFragmentArgs implements NavArgs {
        ...
        if (bundle.containsKey("root_directory")) {
            ...
            if (rootDirectory == null) {
                throw new IllegalArgumentException(
                        "Argument \"root_directory\" is marked as non-null but was passed a null"
                            + " value.");
            }
            __result.arguments.put("root_directory", rootDirectory);
        } else {
            throw new IllegalArgumentException(
                    "Required argument \"root_directory\" is missing and does not have an"
    ...
    public boolean equals(Object object) {
        ...
        if (arguments.containsKey("root_directory")
                != that.arguments.containsKey("root_directory")) {
            return false;
        }
        if (getRootDirectory() != null
                ? !getRootDirectory().equals(that.getRootDirectory())
                : that.getRootDirectory() != null) {
            return false;
        }
        return true;
    }
