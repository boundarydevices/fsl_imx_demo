                ...
                new Thread() {
                    public void run() {
                        try {
                            ...
                            if (isRandom == true) {
                                SleepDelayTimeRandom =
                                        SleepDelayTime
                                                + (int) (Math.random() * 500)
                                                - (int) (Math.random() * 500);
                                AwakeDelayTimeRandom =
                                        AwakeDelayTime
                                                + (int) (Math.random() * 500)
                                                - (int) (Math.random() * 500);
                            } else {
                            ...
                            if (action.equals("sleep")) {
                                ...
                                Intent newIntent =
                                        new Intent("android.intent.action.MY_SLEEP_AWAKE");
                                ...
                                newIntent.putExtra(
                                        "ExpectedTime",
                                        System.currentTimeMillis() + SleepDelayTime);
                                ((AlarmManager) context.getSystemService("alarm"))
                                        .set(
                                                AlarmManager.RTC_WAKEUP,
                                                System.currentTimeMillis() + SleepDelayTimeRandom,
