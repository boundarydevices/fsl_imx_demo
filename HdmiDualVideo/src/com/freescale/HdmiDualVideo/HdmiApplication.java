    ...
    public final class DemoPresentation extends Presentation {
                    ...
                    case UPDATE:
                        {
                            ...
                            getTextView1()
                                    .setText(
                                            "FullScreen: "
                                                    + mvideoview1.getCurrentPosition() / 1000
                                                    + "s"
                                                    + " "
                                                    + "SmallScreen: "
                                                    + mvideoview2.getCurrentPosition() / 1000
                                                    + "s");
        ...
        public void pauseVideo() {
            if (mVideoRunning) {
                mVideoRunning = false;
                mvideoview1.pause();
                if (mVideo2Created == true) mvideoview2.pause();
            }
        }
        ...
        public void resumeVideo() {
            if (mVideoRunning == false) {
                mVideoRunning = true;
                mvideoview1.start();
                if (mVideo2Created == true) mvideoview2.start();
            }
        }
