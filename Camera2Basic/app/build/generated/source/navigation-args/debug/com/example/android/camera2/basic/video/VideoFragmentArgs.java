...
public class VideoFragmentArgs implements NavArgs {
    ...
    public static VideoFragmentArgs fromBundle(@NonNull Bundle bundle) {
        ...
        if (bundle.containsKey("camera_id")) {
            ...
            if (cameraId == null) {
                throw new IllegalArgumentException(
                        "Argument \"camera_id\" is marked as non-null but was passed a null"
                            + " value.");
            }
            __result.arguments.put("camera_id", cameraId);
        } else {
            throw new IllegalArgumentException(
                    "Required argument \"camera_id\" is missing and does not have an"
        ...
        if (bundle.containsKey("width")) {
            ...
            throw new IllegalArgumentException(
                    "Required argument \"width\" is missing and does not have an"
                        + " android:defaultValue");
        }
        if (bundle.containsKey("height")) {
            ...
            throw new IllegalArgumentException(
                    "Required argument \"height\" is missing and does not have an"
                        + " android:defaultValue");
        }
        if (bundle.containsKey("fps")) {
            ...
            throw new IllegalArgumentException(
                    "Required argument \"fps\" is missing and does not have an"
                        + " android:defaultValue");
        }
        return __result;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (getCameraId() != null
                ? !getCameraId().equals(that.getCameraId())
                : that.getCameraId() != null) {
            return false;
        }
